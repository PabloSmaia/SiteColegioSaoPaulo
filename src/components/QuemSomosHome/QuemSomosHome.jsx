            ...
            <div className="flex w-full h-[681px] items-center ">
              ...
              <div className="py-4 sm:py-8 break-words sm:ml-36 md:mt-5 lg:-mt-64 w-[95%] sm:w-[50%] ml-2 text-white absolute bg-black/40 backdrop-blur-sm p-7 rounded-md  ">
                ...
                <h2 className="font-sans font-bold  text-[15px] sm:text-[20px]">
                  ...
                  evangelizadora através da comunidade educativa, tendo por base
                  o Evangelho que desperta para a fraternidade cristã e que leva
                  cada pessoa a assumir o seu destino histórico e a empenhar-se
                  na transformação da sociedade, tendo em vista o seu bem
                  pessoal e o da comunidade humana
                </h2>
              </div>
            </div>
          </section>
